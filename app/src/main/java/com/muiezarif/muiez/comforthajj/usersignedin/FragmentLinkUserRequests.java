 ...
 */
public class FragmentLinkUserRequests extends Fragment {
    AdView adView;
    InterstitialAd interstitialAd;
    ListView requestLinkUsersList;
    ...
    public FragmentLinkUserRequests() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_fragment_link_user_requests, container, false);
        adView=v.findViewById(R.id.adViewfriendrequest);
        ...
        requestLinkUsersList=v.findViewById(R.id.link_request_list);
        user= FirebaseAuth.getInstance().getCurrentUser();
        presenceReference=FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid());
        requestReference= FirebaseDatabase.getInstance().getReference().child("connect_request").child(user.getUid());
        ...
        requestLinkUsersList.setAdapter(adapter);
